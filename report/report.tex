...
Dans le cas ou l'on veut avoir une IP fixe, il faut modifier dans le routeur afin d'associer une IP à l'addresse MAC de notre machine, puis la machine recevra automatiquement son 
