...
\colorbox{yellow}{\textcolor{red}{!! FAUX, MODIFIER}}


Pour avoir un DNS fonctionnel, il est impératif d'avoir une addresse IP fixe, dans j'utiliserai donc toujours la même IP tout au long du projet. J'ai donc choisi \texttt{192.168.1.69}, avec comme réseau local : \texttt{192.168.1.0/24}.
...
Comme nom de domaine en local, nous utiliserons \texttt{trifoil.local}.
